...
<body>
    <section class="success-page">
        ...
        <div class="pay-page-btn">
            <a href="{{ route('home') }}">
                <button class="pay-home-btn">Go to Home</button>
            </a>
            
            <a href="{{ route('paymentReceipt.downloadPDF', ['id' => $payment->id]) }}">
                <button class="pay-save-btn">Save Receipt</button>
            </a>

            {{-- <a href="{{ route('paymentReceipt.downloadPDF') }}">
                <button class="pay-save-btn">Save Receipt</button>
            </a> --}}
        </div>
